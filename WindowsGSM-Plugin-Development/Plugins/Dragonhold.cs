...
{
    public class Dragonhold : SteamCMDAgent
    {
        // - Plugin Details
        public Plugin Plugin = new Plugin
        {
            name = "WindowsGSM.Dragonhold", // WindowsGSM.XXXX
            author = "raziel7893",
            description = "WindowsGSM plugin for supporting Dragonhold Dedicated Server",
            version = "1.0.0",
            url = "https://github.com/Raziel7893/WindowsGSM.Dragonhold", // Github repository link (Best practice) TODO
            color = "#34FFeb" // Color Hex
        };

        // - Settings properties for SteamCMD installer
        public override bool loginAnonymous => true;
        public override string AppId => "3555820"; // Game server appId Steam
        public string GameId => "1510330"; // Game appId Steam

        // - Standard Constructor and properties
        public Dragonhold(ServerConfig serverData) : base(serverData) => base.serverData = serverData;

        // - Game server Fixed variables
        //public override string StartPath => "DragonholdServer.exe"; // Game server start path
        public override string StartPath => "Dragonhold\\Binaries\\Win64\\DragonholdServer-Win64-Shipping.exe";//"DragonholdServer.exe";//the test will change sometime, you can use DragonholdServer.exe as a backup then
        public string BackupExe => "DragonholdServer.exe";
        public string FullName = "Dragonhold Dedicated Server"; // Game server FullName
        ...
        public string Additional = "-server -log -AUTH_TYPE=deviceid -AUTH_LOGIN=test -AUTH_TOKEN=test -EOSConfig=ServerConfig"; // Additional server start parameter
