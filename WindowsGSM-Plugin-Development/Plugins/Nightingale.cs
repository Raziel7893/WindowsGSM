...
namespace WindowsGSM.Plugins
{
    public class Nightingale : SteamCMDAgent
    {
        ...
        {
            name = "WindowsGSM.Nightingale", // WindowsGSM.XXXX
            author = "raziel7893",
            description = "WindowsGSM plugin for supporting Nightingale Dedicated Server",
            version = "1.0.0",
            url = "https://github.com/Raziel7893/WindowsGSM.Nightingale", // Github repository link (Best practice) TODO
            color = "#34FFeb" // Color Hex
        };

        // - Settings properties for SteamCMD installer
        public override bool loginAnonymous => true;
        public override string AppId => "3796810"; // Game server appId Steam

        // - Standard Constructor and properties
        public Nightingale(ServerConfig serverData) : base(serverData) => base.serverData = serverData;

        // - Game server Fixed variables
        //public override string StartPath => "NightingaleServer.exe"; // Game server start path
        public override string StartPath => "NWX\\Binaries\\Win64\\NWXServer-Win64-Shipping.exe";//"NWXServer.exe";
        public string FullName = "Nightingale Dedicated Server"; // Game server FullName
        public string ConfigFile = "Nightingale_conf.json"; // Game server FullName
