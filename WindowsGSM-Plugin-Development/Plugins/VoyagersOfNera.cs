...
{
    public class VoyagersOfNera : SteamCMDAgent
    {
        // - Plugin Details
        public Plugin Plugin = new Plugin
        {
            name = "WindowsGSM.VoyagersOfNera", // WindowsGSM.XXXX
            author = "raziel7893",
            description = "WindowsGSM plugin for supporting VoyagersOfNera Dedicated Server",
            version = "1.0.0",
            url = "https://github.com/Raziel7893/WindowsGSM.VoyagersOfNera", // Github repository link (Best practice) TODO
            color = "#34FFeb" // Color Hex
        };

        // - Settings properties for SteamCMD installer
        public override bool loginAnonymous => true;
        public override string AppId => "3937860"; // Game server appId Steam

        // - Standard Constructor and properties
        public VoyagersOfNera(ServerConfig serverData) : base(serverData) => base.serverData = serverData;

        // - Game server Fixed variables
        //public override string StartPath => "VoyagersOfNeraServer.exe"; // Game server start path
        public override string StartPath => "BoatGame\\Binaries\\Win64\\BoatGameServer-Win64-Shipping.exe";//"NWXServer.exe";
        ...
        public async Task<Process> Start()
        {
            ...
            p.StartInfo.EnvironmentVariables.Add("EOS_OVERRIDE_HOST_IP", "YOUR.PUBLIC.IP_TO_BE_USED");
            // Start Process
            try
            {
                p.Start();
